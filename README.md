...
Its properties are:
  ...
  **NOTE 1**: This is needed because we are using private channels and Pusher requires an authentication endpoint WebSocket connection can be accepted or not. (I also thinks we can omit this params and let the component retrieve these informations).
